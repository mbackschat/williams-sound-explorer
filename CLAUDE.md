...
- **Sound Designer mode (internals)**: [`docs/designer_implementation.md`](docs/designer_implementation.md) (impl state); roadmap + decision log in [`plans/designer-mode.md`](plans/designer-mode.md) — the separate Design mode for authoring VARI sounds
