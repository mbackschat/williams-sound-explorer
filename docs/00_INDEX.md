...
**All 12 UX patterns from `docs/pedagogical_design.md` are delivered.** The **Sound Designer** ships with three engines (VARI + GWAVE + LFSR) across three games (Defender / Stargate / Robotron), a "fork-the-game" pre-populated item list, **Open in Explore** for live worklet audition, and a full `.bin` download/upload roundtrip for MAME / real-cabinet use.
